...
public class DynamicProjectileEntity extends Projectile implements IEntityAdditionalSpawnData {

    private static final EntityDataAccessor<Integer> DATA_COLOR =
            SynchedEntityData.defineId(DynamicProjectileEntity.class, EntityDataSerializers.INT);
    ...
    public DynamicProjectileEntity(EntityType<? extends DynamicProjectileEntity> pEntityType, Level pLevel) {
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        ...
        if (!this.level().isClientSide() && pResult.getEntity() instanceof LivingEntity target && target.isAlive()) {
    ...
    private void performSplit() {
        ...
        for (int i = 0; i < this.splitCount; i++) {
            ...
            EntityType<DynamicProjectileEntity> entityType = (EntityType<DynamicProjectileEntity>) this.getType();

            DynamicProjectileEntity splitProjectile = new DynamicProjectileEntity(entityType, this.level());
